...
if __name__ == '__main__':
    ...
    if startup:
        # Get the strategy values
        strategy = macd_crossover_strategy.macd_crossover_strategy(
            symbol="ETHUSD",
            timeframe="H1"
        )
        print(strategy)
        # Extract only successful trades
        strategy_true = strategy[strategy['crossover'] == True]
        print(strategy_true)
